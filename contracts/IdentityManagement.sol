...
contract IdentityManagement {
    ...
    function addUserDL(string memory _DL_No, string memory _DL_Name, string memory _DL_DOB, string memory _DL_Address) external {
        userDLMap[msg.sender].push(UserDL(_DL_No, _DL_Name, _DL_DOB, _DL_Address));
    }

    function addDLRequest(string memory _requestedBy, string memory _DL_No, string memory _DL_Name, string memory _DL_DOB, string memory _DL_Address, uint8 _DL_OverAll_Status) external {
        DLRequestMap[msg.sender].push(DLRequest(_requestedBy, _DL_No, _DL_Name, _DL_DOB, _DL_Address, _DL_OverAll_Status));
    }
    ...
    function viewDLRequestDetail(uint256 _requestIndex) external view returns (string memory, string memory, string memory, string memory, string memory, uint8) {
        require(_requestIndex < DLRequestMap[msg.sender].length, "Invalid request index");
        DLRequest memory thisDLRequest = DLRequestMap[msg.sender][_requestIndex];
        return (thisDLRequest.requestedBy, thisDLRequest.DL_No, thisDLRequest.DL_Name, thisDLRequest.DL_DOB, thisDLRequest.DL_Address, thisDLRequest.DL_OverAll_Status);
    }

    function updateRequestStatus(uint256 _requestIndex, string memory _DL_No, string memory _DL_Name, string memory _DL_DOB, string memory _DL_Address, uint8 _DL_OverAll_Status) external {
        require(_requestIndex < DLRequestMap[msg.sender].length, "Invalid request index");
    ...
    function viewUserDL(uint256 _requestIndex) external view returns (string memory, string memory, string memory, string memory,string memory,string memory,string memory,string memory) {
    ...
    DLRequest memory thisDLRequest = DLRequestMap[msg.sender][_requestIndex];
    return (thisDLRequest.DL_No, thisUserDL.DL_No, thisDLRequest.DL_Name, thisUserDL.DL_Name, thisDLRequest.DL_DOB, thisUserDL.DL_DOB, thisDLRequest.DL_Address, thisUserDL.DL_Address);
}
}